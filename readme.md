...
![Posts showing revisions](https://raw.githubusercontent.com/petenelson/wp-revision-list/trunk/assets/screenshot-1.png)

### 2. Custom post type support ###
![Custom post type support](https://raw.githubusercontent.com/petenelson/wp-revision-list/trunk/assets/screenshot-2.png)

### 3. Plugin settings ###
![Plugin settings](https://raw.githubusercontent.com/petenelson/wp-revision-list/trunk/assets/screenshot-3.png)

### 4. Number of revisions configurable per user ###
![Number of revisions configurable per user](https://raw.githubusercontent.com/petenelson/wp-revision-list/trunk/assets/screenshot-4.png)
